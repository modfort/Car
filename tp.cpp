...
#define TAILLE 800  
/*
    cette  fonction genera un noued aleatoire  a la posiotion nleatoire
    x y
*/
...
/*
    a partir d'un fichier genere un graph
*/
...
*/
/*
    nous affiche un graphe a de style noued : liasion 1 liasion 2 ...etc
*/
void affiche(){
...
*/
/*
    verifie l'existence de lisaion entre val1 et val 2
*/
...
/*
    initilize aleatoirement un graph de val
*/
...
/*
supprime tout les graph qui n'ont pas de liasan
*/
...
/*
    Fonction qui nous affichent ce qui se deroulent en graphique grace a la bibliotheque sfml
*/
